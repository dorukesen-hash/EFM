...
export default function Bio() {
  return (
    <section className="max-w-[1440px] w-full page-container flex flex-col md:flex-row items-center justify-center text-primary pt-20 md:pt-30 pb-16 md:pb-20 px-4 md:px-12 bg-white shadow-lg">
      <div className="w-full md:w-1/3 flex justify-center items-center mb-6 md:mb-0">
        <Image
          ...
          width={320}
          height={420}
          className="rounded-2xl shadow-lg object-cover w-56 h-72 md:w-[320px] md:h-[420px]"
        />
      </div>
      <div className="w-full md:w-2/3 flex flex-col justify-center items-start text-left max-w-3xl">
