        ...
        <section className=" relative max-w-[1440px] w-full flex flex-col items-center justify-center text-primary pt-30 pb-20 bg-white text-primary">
            ...
            <button onClick={prev} aria-label="Önceki" className="group mt-36 w-10 h-10 flex items-center justify-center text-2xl bg-transparent cursor-pointer">
                <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                    ...
                    className="transition-colors duration-300 group-hover:fill-secondary fill-primary">
            ...
            <div className=" w-[80%] flex flex-col items-center bg-foreground rounded-md shadow-lg p-8">
                <h3 className="text-2xl font-bold mb-4 text-center">{article.title}</h3>
                <div className="mb-4 text-center">Yazar: Enver Furkan METE</div>
                <p className=" w-[80%] mb-6 text-center line-clamp-5">{article.summary}</p>
                ...
                <button onClick={next} aria-label="Sonraki" className="group mt-36 w-10 h-10 flex items-center justify-center text-2xl bg-transparent cursor-pointer">
                <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                    width="512.000000pt" height="512.000000pt" viewBox="0 0 512.000000 512.000000"
                    preserveAspectRatio="xMidYMid meet"
                    className="transition-colors duration-300 group-hover:fill-secondary fill-primary">
