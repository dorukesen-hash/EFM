...
export default function Values() {
    return (
        <section className="max-w-[1440px] w-full flex flex-col items-center justify-center text-primary bg-white pt-30 pb-20 border-t-1 border-secondary">
            <h2 className="text-4xl font-bold mb-10">Değerlerimiz</h2>
            <div className="flex flex-wrap gap-8 w-full justify-center">
                <div className="p-6 flex w-[360px] flex-col items-center text-center value-card rounded-lg">
